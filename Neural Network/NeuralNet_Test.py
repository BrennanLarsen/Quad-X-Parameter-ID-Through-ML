...
#    Helper Functions
# ================================================== #
def denormalize_data(data_normalized, norm_params, columns):  # reverse normalization using stored params
...
def normalize_data(data, norm_params, columns):  # min-max normalization using stored params
