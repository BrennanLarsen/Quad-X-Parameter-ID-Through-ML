...
# Data file paths
data_path = r"TRAINING_DATA_FILE_PATH_HERE.xlsx"
test_data_path = r"TESTING_DATA_FILE_PATH_HERE.xlsx"


# Select which feature to output and use best hyperparameters found
# 0: c_T (Thrust Coeff)
        # max_depth = 6
        # min_samples_split = 2
        # min_samples_leaf = 1 
...
#    Test model
# ================================================== #
from SingleDecisionTree_Test import evaluate_model
